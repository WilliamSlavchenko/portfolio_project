    ...
    return (
        <div className="h-screen flex items-center justify-center bg-white relative">
            <div className="flex flex-col items-start">
                <p className="text-6xl mt-[6rem] mb-5 mr-[80px] font-light text-richgray">I build stuff</p>
                <p className="text-sm max-w-xl mb-6 mr-[80px] font-bold text-black">You can find my work on my GitHub page</p>
                <a
                    href="https://github.com/WilliamSlavchenko"
                    target="_blank"
            ...
            <div className="flex flex-col items-start">
                ...
                <p className="text-sm max-w-xl mb-6 ml-[80px] font-bold text-black">You can find my work on my GitHub page</p>
                <a
                    href="https://github.com/WilliamSlavchenko"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-white border-2 border-blue-500 text-blue-500 font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline mt-4 ml-[80px] inline-block"
                    style={{ minWidth: '150px', fontSize: '16px', transform: 'translateX(50px)', borderRadius: '0' }}
                >
                    See my work
                </a>
